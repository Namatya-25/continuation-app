/* ============================================================
   レベル・階級・破壊対象のマスタデータ
   バランス調整はこのファイルだけを触れば済む
   ============================================================ */

// 各レベルに必要な「累計達成日数」
// Lv1 = 1日目、Lv2 = 3日目（モックの「次のレベルまであと2日」に一致）、以降1日ごと
export const THRESH = [1].concat(Array.from({ length: 29 }, (_, i) => i + 3));

// 災害の見た目の段階。min = そのレベル以上で適用
export const TIERS = [
